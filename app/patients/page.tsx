  ...
  return (
    <div className="page-container pb-24">
      ...
      <div className="bg-green-600 px-4 pt-12 pb-5">
        ...
        <p className="text-green-100 text-sm mt-0.5">{patients.length} cadastrados</p>
      </div>
      ...
      <div className="px-4 mt-4 flex gap-2">
        ...
        <Link
          href="/patients/new"
          className="bg-green-600 text-white rounded-xl px-3 flex items-center gap-1 text-sm font-semibold hover:bg-green-700 transition-colors"
        >
          <Plus size={16} />
        </Link>
      </div>
      ...
      <div className="px-4 mt-4 space-y-2">
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-12 text-gray-400">
            ...
            <Link href="/patients/new" className="text-green-600 text-sm font-medium mt-2 block">
              + Cadastrar paciente
            </Link>
          </div>
        )}
